...
use crate::photos::handlers::{download_full_file, get_color_theme_handler, get_full_item_handler, get_photo_thumbnail, get_random_photo, stream_video_handler, update_media_item_handler};
...
pub fn photos_protected_router() -> Router<ApiContext> {
    Router::new()
        ...
        .route("/photos/item", get(get_full_item_handler).put(update_media_item_handler))
